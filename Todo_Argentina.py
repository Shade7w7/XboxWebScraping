...
URL_PAGE = "https://www.xbox.com/es-AR/games/all-games/console?xr=shellnav"
...
def Obtain_Data(driver):
    ...
    for infobox in infobox_elements:
        ...
        if title_element and price_element:
            ...
            price = price_element[0].text.replace("ARS$", "").replace("+", "").strip()
...
def save_to_excel(all_data):
    ...
    excel_file_name = "Listado_completo_juegos_argentina.xlsx"
